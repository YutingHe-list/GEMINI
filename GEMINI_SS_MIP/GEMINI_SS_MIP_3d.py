...
from utils.Transform_3d import SpatialTransform3D, AppearanceTransform_appearance
from utils.dataloader_SSP_brain import DatasetFromFolder3D as DatasetFromFolder3D_train
from utils.losses3d import gradient_loss, MSE, ncc_loss_mask, cos_loss
...
class Trainer(object):
    def __init__(self, start_epoch=0,
                 ...
                 iters=200,
                 batch_size=1,
                 unlabeled_dir='data/brain',
                 checkpoint_dir='weights',
                 result_dir='results',
                 model_name='GEMINI_SS_MIP_3d'
                 ):
        ...
        # data augmentation
        self.spatial_aug = SpatialTransform3D(do_rotation=True,
